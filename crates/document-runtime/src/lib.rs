//! VentoAgentRuntime's in-tree document conversion engine.
//!
...
pub use provider::{OcrProvider, ProviderError, TranscriptionProvider, VisionProvider};
pub use runtime::{
    AssetDescriptor, ConvertOptions, ConvertResult, DocumentInput, DocumentRuntime,
    ExtractionDecision, InspectionResult, RuntimeError, SourceMetadata, SupportedFormat, convert,
    get_supported_formats, inspect,
};
